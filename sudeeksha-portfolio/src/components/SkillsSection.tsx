...
const skillGroups = [
  ...
  {
    title: 'Databases',
    skills: ['PostgreSQL', 'SQL', 'MySQL', 'MongoDB'],
  },
  {
    title: 'AI & ML',
    skills: ['Machine Learning', 'YOLOv5', 'OpenCV', 'LSTM', 'CNN-LSTM', 'Random Forest'],
  },
  {
    title: 'Frameworks & Tools',
    skills: ['FastAPI', 'Pydantic', 'Streamlit', 'Flask', 'Docker', 'Git', 'GitHub'],
  },
  {
    title: 'Core CS',
    skills: ['Object-Oriented Programming', 'Data Structures & Algorithms', 'Computer Networking'],
  },
];

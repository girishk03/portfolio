...
const contactInfo = [
  { icon: Mail, label: 'Email', value: 'saigirishchalla574@gmail.com', href: 'mailto:saigirishchalla574@gmail.com' },
  { icon: MapPin, label: 'Location', value: 'Hyderabad, Telangana', href: null },
  { icon: Phone, label: 'Phone', value: '+91 9100356461', href: 'tel:+919100356461' },
];
...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const to = 'saigirishchalla574@gmail.com';
